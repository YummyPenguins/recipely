...
class AddNoteScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      text: props.navigation.state.params.ingredients,
      isAdding: false
    };
  }
  ...
  onAddPress = () => {
    ...
    fetch(
      "https://yummypenguin-recipely.herokuapp.com/api/users/recipes/notes",
      {
        method: "POST",
        headers: {
      ...
      .then(newNote => {
        ...
        this.props.screenProps.onNotesChange(
          ...
          () => {
            ...
            onGoBack(
              this.props.screenProps.notes.filter(
        ...
        <View style={styles.wrapper}>
          <View style={styles.inputWrap}>
            <TextInput
              style={[
                styles.input,
                { height: Math.max(40, this.state.height + 10) }
              ]}
              autoFocus={true}
              multiline={true}
              onChangeText={text => {
